...
<figure align="center">
  <img src="docs/public/demo/pyrpc_demo.gif" alt="pyRPC demo" style="width: 100%; max-width: 800px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.08); margin: 24px 0;" />
  <figcaption>
    <p align="center">
