...
import { AccordionProvider, AccordionFolder } from '../sidebar/accordion-folder';
...
export function DocsLayout({
  ...
  function sidebar() {
    ...
    const sidebarComponents = { Folder: AccordionFolder, ...components };
    const viewport = (
      <SidebarViewport>
        <AccordionProvider>
          {menuItems
          ...
          <SidebarPageTree {...sidebarComponents} />
        </AccordionProvider>
      </SidebarViewport>
    );
