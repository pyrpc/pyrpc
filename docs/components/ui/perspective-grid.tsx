        ...
        >
            ...
            >
                ...
                {mounted &&
                    tiles.map((_, i) => (
                        <div
                            key={i}
                            className="tile min-h-[1px] min-w-[1px] border border-fd-border bg-transparent transition-colors duration-[1500ms] hover:duration-0"
                        />
                    ))}
            </div>
            ...
            {showOverlay && (
                <div
                    ...
                    style={{
                        background: `radial-gradient(circle, transparent 25%, var(--fd-background) ${fadeRadius}%)`,
                    }}
                />
            )}
        </div>
