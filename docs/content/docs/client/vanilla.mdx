...
description: Use RPCClient to call your pyRPC server from Python.

---

# Vanilla Python Client

The Python client gives you a dynamic, ergonomic way to call your pyRPC server.
...
HTTP errors (non‑2xx) raise `httpx` exceptions before pyRPC even sees the payload.

## Next Steps

- [Next.js / TypeScript Client](/docs/client/adapters/nextjs)
