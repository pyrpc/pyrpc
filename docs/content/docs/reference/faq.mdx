...
Run `pyrpc dev`. On first run it walks you through setup, creates a `pyrpc.json` config, and generates `__pyrpc.ts` in your client project automatically. For CI, use `pyrpc codegen`.
