...
- [Error Handling](/docs/concepts/error-handling), structured errors that flow back from procedures
- [Client: React](/docs/client/react), turning procedures into hooks in practice
