...
The `npm install @pyrpc/client` creates a `pyrpc-client.json` config file in your client project. The postinstall script then prompts for the distribution mode:
