...
mount_django(urlpatterns)        # appends POST /rpc and GET /rpc`}</pre>
                <p>
                    The import in <code>urls.py</code> is not style &mdash; it is the registration mechanism. Miss
...
{ "backend": { "framework": "django",
               ...
               "types_module": "myproject.views" } }`}</pre>
                <ul className="list-disc pl-5 space-y-2">
                    ...
                    <li><strong>Omitting types_module</strong> fails loudly at startup with instructions &mdash; because guessing wrong produces an empty schema silently.</li>
                ...
                <p>
                    ...
                    your edit immediately &mdash; no cached-importer staleness. Under the old model (importing the
                ...
                <p>
                    ...
                    Your React/Vue/Svelte/Next code cannot tell Django from FastAPI &mdash; which is the point.
                </p>
            </section>
        </article>
    )
