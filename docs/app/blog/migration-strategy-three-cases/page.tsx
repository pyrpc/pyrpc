...
export default function MigrationStrategyPost() {
 ...
 <p>
 This early return is important, it means migration only fires when
 ...
 doesn&rsquo;t have a types file yet, the directory might not even exist.
 </p>
 <p>
 ...
 exactly, same content, same permissions, same modification time. The
 ...
 different. This means the type definitions diverged, perhaps the server
 ...
 files don&rsquo;t contain secrets, but they do represent work, and
 ...
 auto-migration is when we can prove the files are identical (case 3a), 
...
4. Compare SHA256 of both files
 ...
 and, in the three most common scenarios (first-time setup, identical
 files, old file missing), no prompt at all. The user only interacts
