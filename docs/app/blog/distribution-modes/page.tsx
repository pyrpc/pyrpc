...
export default function DistributionModesPost() {
        ...
        <article className="max-w-3xl mx-auto px-6 py-20">
            <div className="mb-12">
                ...
                <h1 className="text-2xl font-bold tracking-tight mt-6 mb-3">
                    Distribution: workspace or server &mdash; and why explicit is better than implicit
                </h1>
  ...
  "client_root": "../frontend"
                ...
                <p>
                    ...
                    right thing to do &mdash; and it forced us to think clearly about what pyrpc actually does.
                </p>
  ...
  "client_root": "../frontend"
                ...
                <p>
                    This is the mode most users will use &mdash; monorepo or same-repo setups where the
...
(If workspace) Where is your TypeScript client project?
  ../frontend`}</pre>
                <p>
                    ...
                    entirely &mdash; it would be meaningless.
                </p>
