...
export default function PyrpcDevConsolePost() {
 ...
 also hosts a small interactive console, a handful of commands for inspecting and
 ...
 <p>
 Six commands. That is the whole interface. Anything beyond these, mutating the
 registry, editing config, calling procedures, is out of scope, because the console
 ...
 contains can never disagree, they are two views of the same data.
 </p>
 <p>
 The import is inside the function, not at module level, the same discipline that
 ...
 _do_regen()`}</pre>
 <p>
 One line, because the debounced, locked, idempotent regen already exists; the console
 ...
 server, a surface that would need safety rails, a security story, and constant
