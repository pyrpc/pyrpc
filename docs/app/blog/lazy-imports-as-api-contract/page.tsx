...
export default function LazyImportsPost() {
 ...
 <li><strong><code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">pyrpc codegen --url</code></strong>, fetch schema from HTTP, generate TypeScript. No Python introspection needed.</li>
 <li><strong><code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">pyrpc codegen schema.json</code></strong>, read schema file, generate TypeScript. Pure file I/O + template rendering.</li>
 <li><strong><code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">pyrpc shell &lt;url&gt;</code></strong>, connect to a running server over HTTP. The server handles introspection.</li>
 <li><strong><code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">pyrpc --version</code></strong>, print version. No core imports needed.</li>
 </ul>
 ...
 <ul className="text-fd-muted-foreground">
 <li><strong><code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">pyrpc pull app.main</code></strong>, import the user's module, walk the registry, save schema. Requires <code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">pyrpc_core.get_registry_schema</code>.</li>
 <li><strong><code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">pyrpc codegen app.main</code></strong>, same import mechanism as <code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">pull</code>, followed by template generation.</li>
 <li><strong><code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">pyrpc inspect app.main</code></strong>, import module, print table of procedures.</li>
 </ul>
 ...
 <ul className="text-fd-muted-foreground">
 <li><strong><code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">pyrpc serve app.main</code></strong>, start uvicorn with the user's app. Needs <code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">PyRPCAsgiApp</code> and <code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">default_router</code>.</li>
 <li><strong><code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">pyrpc dev app.main</code></strong>, serve + watcher + dev console. Needs core at startup.</li>
 </ul>
