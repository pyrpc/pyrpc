        ...
        <article className="max-w-3xl mx-auto px-6 py-20">
            ...
            <section className="prose dark:prose-invert max-w-none text-sm leading-relaxed space-y-5 text-fd-muted-foreground [&_strong]:text-fd-foreground">
                <p>
                    ...
                    interactive console &mdash; just types, kept fresh in the background. If you prefer to own
                ...
                <p>
                    ...
                    <code>_make_regen_callback</code> returns the debounced regen pair &mdash;
                    <code>_do_regen</code> and <code>schedule</code> &mdash; that turn file events into fresh
    ...
    if client:
        ...
        client_dirs = _get_clients(cfg)`}</pre>
                <p>
                    ...
                    <code>pyrpc.json</code>, and <code>_read_config()</code> parses it &mdash; returning
...
if not client_dirs:
    ...
    raise typer.Exit(1)`}</pre>
                <p>
                    The temptation is to fall back to something sensible &mdash; import <code>main</code>,
                ...
                <p>
                    ...
                    of the entry module &mdash; re-firing all the <code>@rpc</code> decorators into
                    <code>default_router</code> &mdash; builds the schema via <code>get_registry_schema</code>,
...
try: t.join()
                ...
                <p>
                    ...
                    stale types &mdash; the exact bug fixed in v0.11.1.
                </p>
                <p>
...
^C
  stopped`}</pre>
                <p>
                    The regeneration lines carry a timestamp prefix &mdash; the callback prints
                    <code>time.strftime(&rsquo;%H:%M:%S&rsquo;)</code> before the proc count &mdash; so you can
                ...
                <p>
                    ...
                    &mdash; <code>dev</code> would also work there thanks to
