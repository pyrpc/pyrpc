...
export default function ServerDetectionProbePost() {
        ...
        <article className="max-w-3xl mx-auto px-6 py-20">
            ...
            <section className="prose dark:prose-invert max-w-none text-sm leading-relaxed space-y-5 text-fd-muted-foreground [&_strong]:text-fd-foreground">
                <p>
                    ...
                    server. Sometimes your server is already running &mdash; you started it yourself, or you&rsquo;re
    ...
    try:
        ...
        return False`}</pre>
                <p>
                    ...
                    <code>&lt; 500</code> check treats any server-side response &mdash; even a 404 from a
                    non-pyRPC app on that port &mdash; as &ldquo;something is listening, don&rsquo;t bind the port
                ...
                <p>
                    The obvious alternative &mdash; try to bind the port and see if it fails &mdash; has a real
                ...
                <p>
                    ...
                    A single retry is deliberately not performed &mdash; if the first probe fails, starting uvicorn
    ...
    console.print(f"  [bold]pyRPC dev[/bold]  http://{host}:{port}/rpc")`}</pre>
                <p>
                    ...
                    guest &mdash; it attaches, regenerates types, watches files, and leaves your process alone.
                </p>
                ...
                <ul className="list-disc pl-5 space-y-2">
                    ...
                    <li><strong>Safe re-runs.</strong> Accidentally running <code>pyrpc dev</code> twice never results in a port conflict &mdash; the second invocation attaches.</li>
                </ul>
                <p>
