...
export default function WorkspaceFlowPost() {
 ...
 and client project live on the same filesystem, a monorepo, or a repo with
 ...
 in workspace mode, config resolution, path validation, type generation,
 ...
 <code>/project/frontend</code>. This is platform-aware, Windows absolute
 ...
 the frontend project. pyrpc will not create a client project for you, that&rsquo;s
...
def regenerate():
 ...
 <p>
 The TypeScript client picks up the change automatically, Vite&rsquo;s HMR,
