...
export default function ArchitectureAsCodePost() {
 ...
 <li><strong>Version-controlled</strong>, <code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">architecture/pyrpc.c4</code> lives in the repo alongside the code</li>
 <li><strong>PR-reviewable</strong>, changes to the architecture ship with the code that causes them</li>
 <li><strong>Multi-level</strong>, one file describes the system landscape, containers, components, and dynamic flows</li>
 <li><strong>Interactive</strong>, <code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">npx likec4 start architecture</code> opens a browser with navigable diagrams</li>
 </ul>
 ...
 <ul className="list-disc pl-6 space-y-1 text-sm">
 <li><strong>5 element kinds</strong>, actor, system, container, component, storage</li>
 <li><strong>30+ model elements</strong>, every package, subpackage, and key class</li>
 <li><strong>25+ relationships</strong>, data flows, HTTP calls, function invocations</li>
 <li><strong>5 static views</strong>, system landscape, containers, core internals, codegen pipeline, client internals, adapter comparison</li>
 <li><strong>3 dynamic views</strong>, RPC call flow, codegen flow, dev loop flow</li>
 </ul>
 ...
 <li><strong>Level 1: System Landscape</strong>, Python Developer, TypeScript Developer, JSON-RPC 2.0 Protocol, and pyrpc as a black-box system.</li>
 <li><strong>Level 2: Container Diagram</strong>, All 7 packages (pyrpc-core, pyrpc-fastapi, pyrpc-flask, pyrpc-django-adapter, pyrpc-codegen, @pyrpc/client, @pyrpc/types) with their HTTP and function-call relationships.</li>
 <li><strong>Level 3: Component Diagrams</strong>, Deep dives into pyrpc-core (Router, Procedure, Interpreter, CLI, ASGI, 10 components total), pyrpc-codegen (5-component pipeline), and @pyrpc/client (Proxy dispatch, CLI sync, postinstall).</li>
 <li><strong>Dynamic Views</strong>, Sequence-style diagrams showing the RPC call flow, code generation pipeline, and dev loop workflow.</li>
 </ol>
