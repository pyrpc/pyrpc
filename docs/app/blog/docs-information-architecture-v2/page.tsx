    ...
    return (
        <article className="max-w-3xl mx-auto px-6 py-20">
            ...
            <section className="prose dark:prose-invert max-w-none text-sm leading-relaxed space-y-5 text-fd-muted-foreground [&_strong]:text-fd-foreground">
                <p>
                    PR #139 reorganized the documentation&rsquo;s information architecture. No new features &mdash;
                ...
                <ul className="list-disc pl-5 space-y-2">
                    ...
                    <li><strong>A dedicated Links section.</strong> After v0.13.0 introduced terminating links, link configuration stopped being a footnote of client creation &mdash; it earned its own overview plus per-link pages.</li>
                    ...
                    <li><strong>An AI resources section</strong> collecting llms.txt, MCP integration, and skills &mdash; acknowledging that a growing share of &ldquo;readers&rdquo; are agents, and they deserve first-class navigation too.</li>
                ...
                <p>
                    ...
                    &ldquo;I use Svelte &mdash; what do I install?&rdquo; or &ldquo;how does batching work?&rdquo;
                ...
                <p>
                    ...
                    (they rendered invisibly &mdash; present, occupying space, painted nothing), removed a stray
