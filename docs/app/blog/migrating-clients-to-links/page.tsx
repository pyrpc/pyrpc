...
const api = createClient<Types>({
  links: [httpBatchLink({ url: "http://localhost:8000" })],
                ...
                <p>
                    ...
                    <code>httpBatchLink</code>. Everything else about your client &mdash; procedure calls, types,
                    error shapes &mdash; is unchanged.
                </p>
...
export const api = createReactClient<Types>({
  links: [httpBatchLink({ url: import.meta.env.VITE_API_URL ?? "http://localhost:8000" })],
                ...
                <ul className="list-disc pl-5 space-y-2">
                    ...
                    <li>Search for old option names (<code>url:</code> directly on <code>createClient</code>) &mdash; TypeScript will flag these as type errors immediately.</li>
                </ul>
                <p>
