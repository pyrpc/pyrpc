        ...
        <article className="max-w-3xl mx-auto px-6 py-20">
            ...
            <section className="prose dark:prose-invert max-w-none text-sm leading-relaxed space-y-5 text-fd-muted-foreground [&_strong]:text-fd-foreground">
                <p>
                    ...
                    a name collision so ordinary &mdash; a function called <code>watch()</code> shadowing
                    <code>from watchfiles import watch</code> &mdash; that it survived several releases.
                </p>
                ...
                <p>
                    ...
                    runtime, so inside that command the local binding won &mdash; and calling what looked like the
    ...
    for changes in watch(  # <- resolves to the local helper, not watchfiles
        ...):`}</pre>
                <p>
                    ...
                    watcher loop &mdash; the <strong>symbol table</strong> was wrong. Static analyzers flag this only
