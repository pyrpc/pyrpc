        ...
        <article className="max-w-3xl mx-auto px-6 py-20">
            ...
            <section className="prose dark:prose-invert max-w-none text-sm leading-relaxed space-y-5 text-fd-muted-foreground [&_strong]:text-fd-foreground">
                <p>
                    ...
                    configuration live? The obvious answer &mdash; <code>pyproject.toml</code>,
                    under <code>[tool.pyrpc]</code> &mdash; was pyrpc&rsquo;s first answer. It
...
entry = "app.main:app"`}</pre>
                <p>
                    ...
                    more involved &mdash; parsing the TOML, finding the <code>[tool.pyrpc]</code>
...
# ... fragile in-place replacement`}</pre>
                ...
                <p>
                    ...
                    file &mdash; re-serializing the entire <code>[tool.pyrpc]</code> section and
                ...
                <p>
                    The biggest problem wasn&rsquo;t technical &mdash; it was semantic. pyrpc
  ...
  "client_root": "../frontend"
    ...
    return os.path.normpath(p)`}</pre>
                ...
                <p>
                    ...
                    a header, not a feature &mdash; but it&rsquo;s the kind of header that saves
                ...
                <p>
                    ...
                    wizard, which creates the file automatically on first run &mdash; most users
                    never need to know the file exists.
                </p>
                <p>
                    The <code>_find_pyrpc_json()</code> function walks up the directory tree
                    (like ESLint&rsquo;s config resolution), so &mdash; like
                    <code>pyproject.toml</code> &mdash; it works from any subdirectory:
                </p>
    ...
    return None`}</pre>
                ...
                <p>
                    ...
                    of those tools &mdash; it&rsquo;s a cross-language RPC framework whose
