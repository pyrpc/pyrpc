        ...
        <article className="max-w-3xl mx-auto px-6 py-20">
            ...
            <section className="prose dark:prose-invert max-w-none text-sm leading-relaxed space-y-5 text-fd-muted-foreground [&_strong]:text-fd-foreground">
                ...
                <ul className="list-disc pl-5 space-y-2">
                    ...
                    <li>Regenerated types are stale &mdash; silently, with a green checkmark.</li>
                </ul>
                <p>
                    For FastAPI single-file apps the entrypoint <em>is</em> the registration module, so the bug hid.
                    Split-module layouts exposed it. The fix is not cleverer reloading machinery &mdash; it is{' '}
...
{ "backend": {
    ...
    "types_module": "myproject.views"   // <- the file with @rpc
                ...
                <p>
                    ...
                    <code>entrypoint</code> &mdash; usually right, because those files typically call{' '}
                ...
                <p>
                    ...
                    <strong>a real registry</strong>. We picked naming &mdash; one string in one JSON file &mdash;
