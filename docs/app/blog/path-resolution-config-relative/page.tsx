...
, it makes the config file a self-contained unit whose meaning doesn&rsquo;t
...
# Both are absolute before any function sees them`}</pre>
 ...
 relative paths with <code>os.getcwd()</code>, which was a time bomb, 
 ...
 eliminates <code>..</code> segments and normalizes separators, critical
 ...
 that have config files, and it&rsquo;s the convention pyrpc now follows.
 </p>
 </section>
 </article>
 )
