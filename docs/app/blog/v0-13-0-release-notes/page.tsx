...
export default function V013ReleasePost() {
  ...
  "clients": [{ "framework": "Next.js", "root": "../frontend" }]
                ...
                <p>
                    The wizard asks the framework first &mdash; sniffing only preselects, Enter confirms.{' '}
                    ...
                    rewritten in place on your next run &mdash; that is the whole migration.
                </p>
...
django       -> python manage.py runserver 127.0.0.1:8000`}</pre>
  ...
  links: [httpBatchLink({ url: "http://localhost:8000" })],
                ...
                <p>
                    ...
                    into one POST array &mdash; dispatched sequentially server-side, capped at 100, each operation
                ...
                <ul className="list-disc pl-5 space-y-2">
                    ...
                    <li><strong><code>pyrpc watch --module X</code></strong> works without a config file again &mdash; and the watchfiles shadowing crash is gone.</li>
                ...
                <p>
                    ...
                    docs, and playground. The sidebar now matches how people arrive &mdash; adapters first, links
                ...
                <ul className="list-disc pl-5 space-y-2">
                    ...
                    <li>Migrate client constructors to the <code>links</code> array &mdash; see the migration post; TypeScript flags every call site.</li>
