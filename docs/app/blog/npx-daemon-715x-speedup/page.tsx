...
export default function NpxDaemon715xSpeedup() {
        ...
        <article className="max-w-3xl mx-auto px-6 py-20">
            ...
            <section className="prose dark:prose-invert max-w-none text-sm leading-relaxed space-y-5 text-fd-muted-foreground [&_strong]:text-fd-foreground">
                <p>
                    ...
                    conversion that drops regeneration time from ~3.3s to ~4.6ms &mdash;
  ...
  └── 0.1s  Jinja2 render + file write`}</pre>
                ...
                <p>
                    ...
                    Node.js process, parse the schema, and emit TypeScript &mdash; then
...
After (subsequent calls):
  ...
  └── 0.1s  Jinja2 render + file write`}</pre>
                ...
                <ul className="space-y-2">
                    <li>
                        <strong>Daemon crash</strong> &mdash; if the Node.js process dies
                    ...
                    <li>
                        <strong>No npm available</strong> &mdash; if <code>npm</code> is not
                        found or the install fails, the daemon is skipped and pyRPC uses
                        the subprocess path transparently.
                    </li>
                    <li>
                        <strong>Concurrent regeneration</strong> &mdash; Python uses a
                    ...
                    <li>
                        <strong>Clean shutdown</strong> &mdash; Python&rsquo;s
...
result = convert_all(defs, opts=opts)`}</pre>
                ...
                <p>
                    ...
                    no longer the bottleneck in the dev loop &mdash; reloading your
                    Python module is.
                </p>
                <p>
                    Read the full
