...
export default function CircularDependencyPost() {
 ...
 they needed, the runtime, the CLI, and the codegen, in one
...
pyrpc-core
 ...
 <p>
 The simplest option: put everything in <code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">pyrpc-core</code>, runtime,
 ...
 user experience, your CLI installs successfully but half the commands
 fail at runtime.
 </p>
 <p>
 ...
 <p>
 <code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">pyrpc-codegen</code> becomes a pure library, no CLI, no typer, no
 ...
 <code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">pyrpc codegen --url</code> do not need <code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">pyrpc-core</code> at all, they
...
pip install pyrpc-core
 ...
 <li><strong>First-run setup prompts</strong> in <code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">pyrpc dev</code>, detect framework, prompt for entry point, write <code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">[tool.pyrpc]</code> to pyproject.toml, install the adapter. All the CLI logic lives in pyrpc-cli, no circular deps.</li>
 <li><strong>Framework adapter auto-install</strong>, <code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">pip install fastapi</code> on first run if the user chooses FastAPI.</li>
 <li><strong><code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">--reconfigure</code></strong>, re-run the setup prompts and overwrite <code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">[tool.pyrpc]</code>.</li>
 <li><strong>Optional <code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">pyrpc shell</code> removal</strong>, the shell lives in pyrpc-cli and can be removed without touching core or codegen.</li>
 </ul>
 <p>
