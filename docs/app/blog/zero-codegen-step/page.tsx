        ...
        <article className="max-w-3xl mx-auto px-6 py-20">
            ...
            <section className="prose dark:prose-invert max-w-none text-sm leading-relaxed space-y-5 text-fd-muted-foreground [&_strong]:text-fd-foreground">
                <p>
                    ...
                    tune it &mdash; <code>_DEBOUNCE_SECONDS = 0.3</code>, the 200ms watchfiles batch, and the
                ...
                <p>
                    ...
                    subdirectories &mdash; deliberately not a recursive walk:
                </p>
...
def _find_python_dirs(root: str) -> list[str]:
    ...
    return dirs`}</pre>
                <p>
                    ...
                    cares about the entry module and the modules it imports &mdash; the schema is rebuilt by
                    reloading the module, not by scanning files &mdash; so watching every nested package
        ...
        if any(f.endswith(".py") for _, f in changes):
            schedule()`}</pre>
                <p>
                    ...
                    the burst of events a single editor save produces &mdash; editors typically create,
                ...
                <p>
                    ...
                    one is subtle and important &mdash; the client directories often live inside the watched
                ...
                <p>
                    ...
                    layer exists because regeneration itself &mdash; importing the module, building the schema,
                    writing files &mdash; should not start until the file has settled. The pattern matches
...
def _make_regen_callback(module: str, client_dirs: list[str]):
    ...
    return _do_regen, schedule`}</pre>
                <p>
                    ...
                    regeneration fires once &mdash; 300ms after the last save &mdash; not three times. The
                ...
                <p>
                    ...
                    decorators and re-registers procedures), and &mdash; critically &mdash; restores the old
...
14:22:30.510  "14:22:30 types regenerated (4 procs) for 1 clients"`}</pre>
                <p>
                    ...
                    schema file or URL, but in the development loop you never type it &mdash; the watcher
                ...
                <p>
                    ...
                    loop fast without wasting work &mdash; fresh types within half a second, exactly one
