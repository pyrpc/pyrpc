...
{"  Done."}</pre>
                <p>
                    ...
                    about the server&rsquo;s file system &mdash; it pulls types on demand.
                </p>
                <p>
          ...
          tests/test_flask.py                  packages/pyrpc-flask/tests/`}</pre>
                <p>
                    ...
                    the relationship between test and package explicit &mdash; especially
                ...
                <p>
                    ...
                    <code>pyrpc.com</code>. Every reference across the codebase &mdash;
                    documentation, links, comments &mdash; was updated at once rather
                ...
                <p>
                    The codebase had a mix of em dashes (U+2014 &mdash;) and regular
                    ...
                    issues &mdash; remnants of early development on mixed-platform setups.
                </p>
                ...
                <ul className="space-y-2">
                    <li>
                        <code>pyrpc-core</code> &mdash; The runtime, CLI, and codegen.
                        One install, everything you need.
                    </li>
                    <li>
                        <code>pyrpc-codegen</code> &mdash; The TypeScript generation
