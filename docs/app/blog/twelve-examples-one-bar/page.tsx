        ...
        <article className="max-w-3xl mx-auto px-6 py-20">
            ...
            <section className="prose dark:prose-invert max-w-none text-sm leading-relaxed space-y-5 text-fd-muted-foreground [&_strong]:text-fd-foreground">
                <p>
                    ...
                    every one of them to the same standard &mdash; because an example that almost works teaches
                ...
                <ul className="list-disc pl-5 space-y-2">
                    <li><strong>Current client API.</strong> Every client uses the links API (<code>httpBatchLink</code> from its adapter package) &mdash; no stale constructor options surviving in any corner.</li>
                ...
                <p>
                    ...
                    meaningful. Usually it is drift &mdash; an example updated in May and not in August.
                    Conformance work is mostly archaeology followed by discipline:
                </p>
                <ul className="list-disc pl-5 space-y-2">
                    <li><code>examples/verification.md</code> doubles as a manual QA script: first-run wizard transcript, hot-reload timing, server-detection attach path, watcher-only mode &mdash; each check executable by hand against any example.</li>
                ...
                <p>
                    ...
                    falsifiable &mdash; there are twelve repos in-tree that prove it, and they all build.
                </p>
            </section>
        </article>
    )
