...
export default function VisualTourPost() {
 ...
 <li><strong>Python Developer</strong>, writes <code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">@rpc</code>-decorated functions and runs the CLI</li>
 <li><strong>TypeScript Developer</strong>, consumes the typed client in frontend apps</li>
 <li><strong>JSON-RPC 2.0 Protocol</strong>, the wire format pyrpc conforms to</li>
 </ul>
 <p>
 This view answers: <em>what are the boundaries of our system?</em> The Python developer is inside pyrpc's world (they write the endpoints). The TypeScript developer is outside (they only see generated types and the client library). JSON-RPC 2.0 is a constraint, pyrpc must speak this language correctly.
 </p>
