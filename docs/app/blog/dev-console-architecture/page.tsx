...
export default function DevConsolePost() {
 ...
 files are watched, types are regenerated, but should there be a prompt?
 ...
 files, and regenerated TypeScript types, all silently. There was no
 ...
 <p>
 The <code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">pyrpc shell</code> command existed as a separate network-based REPL, 
...
pyrpc shell --url http://localhost:8000`}
 ...
 and lets you call procedures remotely. It works against any server, 
 localhost, staging, or production, using the same protocol that frontend
 clients use.
 </p>
 <p>
 ...
 something that felt like <code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">rails console</code> or <code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">django-admin shell</code>, 
 ...
 <code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">node</code>, and <code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">irb</code>, the REPL lives inside the same process as the
 ...
 <p>
 <strong>Weaknesses:</strong> uvicorn blocks the main thread, you
 ...
 REPL prompts fight over stdout, imagine <code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">kubectl logs</code> showing
...
pyrpc> exit`}
 ...
 <p>
 A daemon thread running <code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">watchfiles.watch()</code>, a Rust-backed file
 ...
 The thread only does file I/O and <code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">importlib.reload()</code>, no
 ...
 loop in the main thread. Commands are dispatched via a dict, O(1)
...
, no network calls, no serialization, instant access. This works because
...
importlib.reload(mod)`}
 ...
 <p>
 The fix was <code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">Router.reload_module()</code>, a new method on the core
