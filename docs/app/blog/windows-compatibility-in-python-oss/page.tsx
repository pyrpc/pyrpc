...
export default function WindowsCompatPost() {
 ...
 <time>June 2, 2026 at 4:00pm</time>
 <span>&middot;</span>
 ...
 <li><strong>Unicode checkmark</strong> (<code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">\u2713</code>), used in CLI output to indicate success. Replaced with <code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">[OK]</code>.</li>
 <li><strong>Em dash</strong> (<code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">, </code>), used in generated TypeScript comments as section separators. Replaced with <code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">---</code>.</li>
 <li><strong>Right arrow</strong> (<code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">\u2192</code>), used in help text. Replaced with <code className="text-[10px] font-mono bg-fd-muted px-1.5 py-0.5 rounded">-&gt;</code>.</li>
 <li><strong>Bullet characters</strong>, used in Rich table rendering. Rich handles these internally, but only if the terminal supports them.</li>
 </ul>
 <p>
 Rich (the library we use for CLI rendering) detects terminal encoding and
 falls back to ASCII replacements automatically, but only for its
...
the next time Git touches it`}
 ...
 contributor on macOS edits a file that was last touched on Windows, 
...
*.html text eol=lf`}
 ...
 notification, no polling, no CPU overhead.
 </p>
 <p>
