    ...
    return (
        <article className="max-w-3xl mx-auto px-6 py-20">
            ...
            <section className="prose dark:prose-invert max-w-none text-sm leading-relaxed space-y-5 text-fd-muted-foreground [&_strong]:text-fd-foreground">
                <p>
                    Before v0.13.0, <code>createClient</code> took transport options directly &mdash; URL, headers,
    ...
    async request(operation: Operation): Promise<OperationResult> {
      ...
      return readJson<OperationResult>(response);
                ...
                <p>
                    ...
                    Everything else is composition territory &mdash; auth injection, retry with backoff, logging,
...
const api = createReactClient<Types>({
  links: [httpBatchLink({ url: process.env.API_URL })],
                ...
                <p>
                    ...
                    slot into the pipeline users already have &mdash; no migration required.
                </p>
            </section>
        </article>
    )
