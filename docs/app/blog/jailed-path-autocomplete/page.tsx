...
export default function JailedAutocompletePost() {
        ...
        <article className="max-w-3xl mx-auto px-6 py-20">
            ...
            <section className="prose dark:prose-invert max-w-none text-sm leading-relaxed space-y-5 text-fd-muted-foreground [&_strong]:text-fd-foreground">
                <p>
                    ...
                    <code>questionary.path</code>: live directory completion, Tab to accept &mdash; and a security
    ...
    return real == root_abs or real.startswith(root_abs + os.sep)`}</pre>
                ...
                <p>
                    ...
                    What you type is not filtered &mdash; you may absolutely write <code>../shared-client</code>,
...
assert out == ["api/", "app/"]      # node_modules never appears anywhere`}</pre>
                <p>
                    ...
                    your own project back &mdash; correct!), absolute escapes like <code>/etc</code>, and the
