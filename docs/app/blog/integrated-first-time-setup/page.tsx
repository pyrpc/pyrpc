...
pyrpc dev # "First run? Let's set up. Also, server's starting."`}</pre>
 ...
 server, and generates types, all in one command.
 </p>
...
pyrpc dev --client-root ../new-client`}</pre>
 ...
 eventually set up pyrpc, fast, deterministic, non-interactive.
 </p>
...
if framework is None:
 ...
 error, cancellation is a normal user action).
 </p>
 ...
 them. The wizard is a fallback, not a prerequisite, it fires exactly
