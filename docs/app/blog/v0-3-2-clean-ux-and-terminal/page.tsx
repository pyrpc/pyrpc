    ...
    return (
        <article className="max-w-3xl mx-auto px-6 py-20">
            ...
            <section className="prose dark:prose-invert max-w-none text-sm leading-relaxed space-y-5 text-fd-muted-foreground [&_strong]:text-fd-foreground">
                <p>
                    v0.3.2 is a UX-focused release. No new features, no breaking changes &mdash;
    ...
    > fastapi
      ...
      asgi`}</pre>
                <p>
                    ...
                    arrow-key select menu &mdash; the same pattern you see in Better Auth,
                ...
                <p>
                    ...
                    <code>module:variable</code> convention &mdash; but pyrpc&rsquo;s
...
pyrpc>`}</pre>
                ...
                <ul className="space-y-2">
                    <li><strong>Uvicorn logs suppressed</strong> &mdash; <code>--log-level error</code> on the subprocess kills 6 lines of reloader/server spam.</li>
                    <li><strong>Panel box gone</strong> &mdash; replaced with a clean 2-line status block. No borders, no padding, just what you need.</li>
