        ...
        <article className="max-w-3xl mx-auto px-6 py-20">
            ...
            <section className="prose dark:prose-invert max-w-none text-sm leading-relaxed space-y-5 text-fd-muted-foreground [&_strong]:text-fd-foreground">
                <p>
                    ...
                    Now one command does both &mdash; launching Flask&rsquo;s own dev server, not an ASGI stand-in.
...
mount_flask(app)`}</pre>
                <p>
                    ...
                    yourself with <code>python main.py</code> at any time &mdash; pyRPC never takes ownership away
                    from you.
                </p>
...
export const api = createNextClient<Types>({
  links: [httpBatchLink({ url: "http://localhost:8000" })],
                ...
                <p>
                    Then ordinary TanStack usage &mdash; <code>api.greet.useQuery(&#123;&#125;)</code>,{' '}
                    <code>api.create_item.useMutation()</code> &mdash; fully typed against the Python signatures.
                </p>
