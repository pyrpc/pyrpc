...
export default function BatchedRpcPost() {
 ...
 batching as a transport optimization, and the phrase is chosen carefully, because the
...
if isinstance(payload, list):
 ...
 <li><strong>Not a new procedure kind.</strong> No special casing downstream, auth, validation, and introspection see exactly what they saw before, per operation.</li>
 </ul>

 <h2 className="text-lg font-bold tracking-tight text-fd-foreground mt-10">The payoff you actually notice</h2>
 <p>
 With TanStack Query adapters, a page mounting four queries fires them in one tick, which
