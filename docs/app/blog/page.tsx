...
const posts: Post[] = [
 ...
 {
  slug: 'from-paper-to-gates',
  title: 'From paper standards to enforced gates',
  description: 'Every engineering standard pyRPC claimed already existed in the repo; none were enforced. The audit, the rule set for closing seven gaps honestly, and what enforcement caught in its first days.',
  date: 'August 25, 2026 at 9:00am',
  readTime: '7 min',
  category: 'deep-dive',
 },
 {
  slug: 'adopting-ruff-374-violations',
  title: 'Adopting ruff into a codebase with 374 violations',
  description: 'The playbook: autofix the boring parts, hand-fix what teaches something (three missing raise-from chains, a closure bug), encode accepted style as documented config, then let CI hold the line.',
  date: 'August 25, 2026 at 10:30am',
  readTime: '7 min',
  category: 'deep-dive',
 },
 {
  slug: 'type-checking-pyrpc',
  title: 'Type checking a library whose product is types',
  description: 'mypy over five Python packages found thirteen errors, including an ASGI transport whose annotation still claimed dict-only payloads after batching shipped. Plus typed lazy globals and a Popen subclass replacing proc._cwd.',
  date: 'August 25, 2026 at 12:00pm',
  readTime: '7 min',
  category: 'deep-dive',
 },
 {
  slug: 'windows-found-a-bug',
  title: 'The Windows CI leg found a real bug on day one',
  description: 'Expanding the matrix to Windows immediately surfaced a first-run crash: jsonc-edit bootstrapped npm via CreateProcess, which cannot execute npm.cmd. Fixed upstream in 0.2.1; floor raised so users get it.',
  date: 'August 25, 2026 at 2:00pm',
  readTime: '7 min',
  category: 'deep-dive',
 },
 {
  slug: 'coverage-floors-without-theater',
  title: 'Coverage floors without theater',
  description: 'Measure first, pick the number second: a hard 78 percent floor against a measured 80, two points of slack absorbing noise instead of inviting gamed tests, and honesty about what line coverage cannot say.',
  date: 'August 25, 2026 at 3:30pm',
  readTime: '6 min',
  category: 'deep-dive',
 },
 {
  slug: 'docs-and-examples-executable-truth',
  title: 'Docs and examples as executable truth',
  description: 'Twelve example apps and dozens of doc snippets were never executed by anything. Now every example imports cleanly in CI, every python fence parses, and fences tagged test run for real.',
  date: 'August 25, 2026 at 5:00pm',
  readTime: '6 min',
  category: 'deep-dive',
 },
 {
  slug: 'dependabot-dual-ecosystems',
  title: 'Dependabot across two lockfile ecosystems',
  description: 'Four surfaces (uv.lock, npm workspaces, docs npm, GitHub Actions), one policy: grouped minor+patch to cut noise, majors kept individual because a major pydantic bump is an event.',
  date: 'August 25, 2026 at 7:00pm',
  readTime: '5 min',
  category: 'deep-dive',
 },
 {
 slug: 'batch-requests-in-pyrpc',
 title: 'Batch requests in pyRPC: how they work and when to use them',
 description: 'A guide to batch RPC operations — what they look like on the wire, how the server processes them, and when httpBatchLink beats httpLink.',
 date: 'August 27, 2026 at 10:00am',
 readTime: '4 min',
 category: 'tutorial',
 },
 {
 slug: 'framework-type-annotations-vs-library-validation',
 title: 'When your framework validates before your library does',
 description: 'The FastAPI batch bug as a case study in double validation — why framework annotations can block library features, and how a one-line type fix resolves it.',
 date: 'August 27, 2026 at 9:30am',
 readTime: '5 min',
 category: 'deep-dive',
 },
 {
 slug: 'v0-14-1-fastapi-batch-fix',
 title: 'pyRPC v0.14.1: Batch requests now work in FastAPI',
 description: 'Patch release: the FastAPI adapter now accepts batch requests. What was broken, why other adapters were fine, and how to upgrade.',
 date: 'August 27, 2026 at 9:00am',
 readTime: '3 min',
 category: 'release',
 },
 {
 slug: 'v0-14-0-release-notes',
  title: 'pyRPC v0.14.0: pyrpc mcp, your backend as an AI-native surface',
  description: 'Release tour: the local MCP server with three read-oriented tools, the no-execution security line, dry-run-first codegen, and lean optional packaging.',
  date: 'August 25, 2026 at 12:00pm',
  readTime: '6 min',
  category: 'release',
 },
 {
  slug: 'introspection-imports-your-code',
  title: 'Introspection that imports your code, on purpose',
  description: 'Static parsers guess; the runtime knows. How the MCP reuses the registry chain from pyrpc.json to get_registry_schema for ground truth.',
  date: 'August 25, 2026 at 11:00am',
  readTime: '5 min',
  category: 'deep-dive',
 },
 {
  slug: 'check-call-never-executes',
  title: 'check_call: validation with execution removed from the universe',
  description: 'Bind-and-validate extracted from Procedure.execute so agents can verify payloads against real types while remaining structurally unable to run your code.',
  date: 'August 25, 2026 at 1:00pm',
  readTime: '4 min',
  category: 'deep-dive',
 },
 {
  slug: 'dry-run-first-codegen',
  title: 'Codegen through an MCP: dry run first, narrow writes, honest hints',
  description: 'The one mutating tool in pyrpc mcp gets a non-mutating default, generated-files-only scope, and annotations that match reality.',
  date: 'August 25, 2026 at 2:00pm',
  readTime: '4 min',
  category: 'deep-dive',
 },
 {
  slug: 'errors-an-agent-can-fix',
  title: 'Errors an agent can fix: the ToolError discipline',
  description: 'Structured failures with remediation baked in: what failed, what state caused it, and the exact next move, for every failure mode the server can hit.',
  date: 'August 25, 2026 at 3:00pm',
  readTime: '5 min',
  category: 'deep-dive',
 },
 {
  slug: 'stdout-belongs-to-the-protocol',
  title: 'stdout belongs to the protocol: stdio discipline in pyrpc mcp',
  description: 'One stray print corrupts an MCP session. How the SDK protects the wire, the two windows it cannot cover, and the tests that make purity mechanical.',
  date: 'August 25, 2026 at 4:00pm',
  readTime: '4 min',
  category: 'deep-dive',
  },
  {
    slug: 'why-mcp-is-an-extra-not-a-default',
   title: 'Why MCP Is an Extra, Not a Default',
   description: 'Eighteen transitive packages including compiled cryptography. The packaging math behind making pyrpc-core[mcp] optional, and why that boundary is permanent.',
   date: 'August 25, 2026 at 9:00am',
   readTime: '7 min',
   category: 'deep-dive',
  },
  {
   slug: 'three-tools-no-more',
   title: 'Three Tools, No More',
   description: 'introspect_project, check_call, run_codegen. How pyRPC chose exactly three tools and why the anti-pattern of too many tools kills agent performance.',
   date: 'August 25, 2026 at 9:30am',
   readTime: '8 min',
   category: 'deep-dive',
  },
  {
   slug: 'local-vs-remote-trust-boundary',
   title: 'Local vs Remote: The Trust Boundary That Matters',
   description: 'Two MCP servers, two trust models. Why the distinction between a subprocess importing your code and a hosted documentation endpoint is the most important design decision.',
   date: 'August 25, 2026 at 10:00am',
   readTime: '9 min',
   category: 'deep-dive',
  },
  {
  ...
  {
   slug: 'testing-the-mcp-like-prisma-does',
   title: 'Testing the MCP Like Prisma Does',
   description: 'Official SDK in-memory clients, raw subprocess JSON-RPC, and the purity test. A 21-test strategy that catches protocol bugs, lifecycle issues, and config regressions.',
   date: 'August 25, 2026 at 11:00am',
   readTime: '8 min',
   category: 'deep-dive',
  },
  {
   slug: 'when-an-agent-breaks-your-schema',
   title: 'When an Agent Breaks Your Schema',
   description: 'AI agents generate plausible but type-incorrect payloads. How pyRPC check_call validates against real Python types and returns per-parameter errors the agent can fix.',
   date: 'August 25, 2026 at 11:30am',
   readTime: '7 min',
   category: 'deep-dive',
  },
  {
   slug: 'the-protocol-is-the-interface',
   title: 'The Protocol Is the Interface',
   description: 'Why MCP is the right abstraction layer for AI-tool integration. JSON-RPC foundations, Streamable HTTP vs stdio, and the thin server principle.',
   date: 'August 25, 2026 at 12:00pm',
   readTime: '8 min',
   category: 'deep-dive',
  },
  {
   slug: 'how-to-add-mcp-to-any-python-framework',
   title: 'How to Add MCP to Any Python Framework',
   description: 'Step-by-step guide to adding pyRPC local MCP to FastAPI, Django, Flask, or any ASGI/WSGI app. Framework-specific gotchas included.',
   date: 'August 25, 2026 at 12:30pm',
   readTime: '9 min',
   category: 'tutorial',
  },
  {
   slug: 'the-catch-with-remote-servers',
   title: 'The Catch With Remote MCP Servers',
   description: 'Claude Desktop refuses them. The auth gap in MCP spec. Rate limits. An honest discussion of remote MCP tradeoffs and why the two-server pattern still works.',
   date: 'August 25, 2026 at 1:00pm',
   readTime: '7 min',
   category: 'deep-dive',
  },
  {
   slug: 'how-to-set-up-mcp-in-under-5-minutes',
   title: 'How to Set Up MCP in Under 5 Minutes',
   description: 'Quickstart for both remote and local MCP. One command for documentation, five minutes for your project. The it-just-works principle.',
   date: 'August 25, 2026 at 1:30pm',
   readTime: '5 min',
   category: 'tutorial',
  },
  {
   slug: 'ai-native-development-what-we-learned',
   title: 'AI-Native Development: What We Learned Building pyRPC MCP',
   description: 'Trust boundaries, read-only-first design, thin servers, protocol convergence. Lessons from building an AI-native Python framework from scratch.',
   date: 'August 25, 2026 at 2:00pm',
   readTime: '10 min',
   category: 'deep-dive',
  },
  {
   slug: 'why-local-mcp-beats-api-docs',
   title: 'Why Local MCP Beats API Docs for AI Agents',
   description: 'Static documentation drifts. MCP imports your actual code. Ground truth vs interpretation, and why structured data beats text for agent performance.',
   date: 'August 25, 2026 at 2:30pm',
   readTime: '7 min',
   category: 'deep-dive',
  },
  {
   slug: 'building-trust-with-ai-agents',
   title: 'Building Trust With AI Agents: The pyRPC Approach',
   description: 'Never-execute guarantees, dry-run-first defaults, structured errors, transparent discovery. How pyRPC design builds trust between developers and agents.',
   date: 'August 25, 2026 at 3:00pm',
   readTime: '8 min',
   category: 'deep-dive',
  },
  {
   slug: 'the-future-of-ai-development-tools',
   title: 'The Future of AI Development Tools',
   description: 'Protocol convergence, registry servers, agent-first design, trust infrastructure. Where AI-native development is heading and what it means for Python frameworks.',
   date: 'August 25, 2026 at 3:30pm',
   readTime: '9 min',
   category: 'deep-dive',
  },
  {
   ...
   title: 'Getting Started With MCP: A Practical Guide',
   description: 'Comprehensive walkthrough for both MCP surfaces. Remote documentation in 30 seconds, local project in 15 minutes, both together in production.',
   date: 'August 25, 2026 at 4:00pm',
   readTime: '10 min',
   category: 'tutorial',
  },
