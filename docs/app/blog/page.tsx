...
const posts: Post[] = [
 ...
 },
 {
  ...
  title: 'Why pyrpc mcp is a subcommand, not a package',
  description: 'Neon deprecated its launcher; Prisma never shipped one. The evidence behind making MCP a native CLI verb instead of artifact number twelve.',
  date: 'August 25, 2026 at 9:00am',
  readTime: '5 min',
  category: 'deep-dive',
 },
 {
  ...
  title: 'Local versus remote MCP is a trust boundary, not a menu',
  description: 'Ten ecosystems studied before building one: Prisma\'s two servers, Neon\'s collapse to hosted, Better Auth\'s auth-less docs server, and the principle underneath.',
 ...
 },
 {
  ...
  title: 'Three tools, and the discipline of stopping there',
  description: 'Context budget is a design constraint. How introspect_project, check_call, and run_codegen earned their slots and everything else got deferred.',
