...
const posts: Post[] = [
 ...
 },
 {
  ...
  title: 'Measured in wheels: why the MCP SDK is an extra, not a default',
  description: 'Eighteen packages including a compiled cryptography wheel. The packaging math, the precedent we nearly misread, and the reversibility asymmetry that settled it.',
  date: 'August 25, 2026 at 5:00pm',
  readTime: '5 min',
  category: 'deep-dive',
 },
 {
  ...
  title: 'Three layers of proof: testing pyrpc mcp end to end',
  description: 'Official in-memory clients, raw subprocess JSON-RPC with stdout purity checks, and a nine-leg matrix that caught a separator bug before release.',
  date: 'August 25, 2026 at 6:00pm',
  readTime: '5 min',
  category: 'deep-dive',
 },
]
