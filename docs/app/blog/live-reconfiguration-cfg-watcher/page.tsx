        ...
        <article className="max-w-3xl mx-auto px-6 py-20">
            ...
            <section className="prose dark:prose-invert max-w-none text-sm leading-relaxed space-y-5 text-fd-muted-foreground [&_strong]:text-fd-foreground">
                <p>
                    ...
                    re-wires itself &mdash; including swapping the backend runtime entirely.
                </p>
                ...
                <p>
                    ...
                    editor atomic-save shims &mdash; all noise. Instead the watcher parses the new JSON into the
...
output_changed  = new_client_dirs != client_dirs`}</pre>
                ...
                <p>
                    ...
                    spec alive if resolution fails), then &mdash; only if pyRPC owns the process &mdash; terminate,
                ...
                <ul className="list-disc pl-5 space-y-2">
                    ...
                    <li><strong>Shutdown eating the batch.</strong> If <code>stop</code> set before the watcher processed its first yield, the change vanished. Fix: the fake keeps yielding batches forever, like watchfiles polling does &mdash; a dropped tick no longer loses the edit.</li>
                ...
                <p>
                    ...
                    rarely about the code under test &mdash; they are about unowned nondeterminism in the harness.
