        ...
        <article className="max-w-3xl mx-auto px-6 py-20">
            ...
            <section className="prose dark:prose-invert max-w-none text-sm leading-relaxed space-y-5 text-fd-muted-foreground [&_strong]:text-fd-foreground">
                <p>
                    ...
                    landing page, unified light/dark theming, and &mdash; the part engineers actually notice
                    &mdash; one syntax palette shared by every code block on the site. This is a retrospective on
                ...
                <p>
                    The site renders Python and TypeScript in three places &mdash; marketing page, docs content,
                    interactive playground &mdash; and each had accumulated its own highlighting setup. The same{' '}
                ...
                <p>
                    ...
                    with paired light/dark token mappings so switching themes never changes semantics &mdash; only
                    luminance.
                </p>
                ...
                <p>
                    The redesign removed more than it added &mdash; wave backgrounds, decorative gradients,
                ...
                <p>
                    ...
                    with its own design system</strong> &mdash; tokens, themes, shared syntax definitions &mdash;
